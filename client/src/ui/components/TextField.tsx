...
export interface TextFieldProps extends Omit<FilledTextFieldProps | StandardTextFieldProps, 'size'> {
    noBorder?: boolean;
    size?: 'small' | 'medium' | 'large' | 'xlarge';
}

function TextField(props: TextFieldProps & WithStyles<typeof styles>) {
    const { classes, InputProps = {}, InputLabelProps, noBorder, size = 'medium', SelectProps, ...other } = props;
